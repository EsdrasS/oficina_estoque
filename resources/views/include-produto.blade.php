      ...
      <section class="wrapper">
        <div id="line-one">
            <div class="container">
               ...
               <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header"><i class="icon_house_alt"></i> Cadastrar Produto</h3>
                            <ol class="breadcrumb">
                                <li><i class="fa fa-shopping-cart"></i><a href="{{route('produto.index')}}">Produtos</a></li>
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="dt_entrada" 
                                       class="form-control" 
                                       required>
                            </div>    
                        </div>  
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea required rows="2" class="form-control" cols="75" name="descricao"></textarea>
                            </div>    
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
