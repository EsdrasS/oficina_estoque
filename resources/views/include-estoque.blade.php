...
<head>
  ...
  <title>Cadastrar estoques</title>
      ...
      <section class="wrapper">
        <div id="line-one">
            <div class="container">
               ...
               <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header"><i class="icon_tag_alt"></i> Cadastrar Estoque</h3>
                            <ol class="breadcrumb">
                                <li><i class="fa fa-tags"></i><a href="{{route('estoque.index')}}">Estoque</a></li>
