  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="icon_tag_alt"></i> Estoques</h3>
            ...
            <br>
                ...
                <div class="row">
                    <div class="col-md-12">   
                        <br />
                        <h4 id="center"><b>Total itens({{$total}})</b></h4>
                        <br>
                                    ...
                                    <tr>
                                        ...
                                        <td id="center">
                                            ...
                                            &nbsp;<form style="display: inline-block;" method="POST" 
                                                        action="{{route('estoque.destroy', $estoque->id)}}"                                                        
